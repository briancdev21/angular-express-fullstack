...
@Component({
  selector: 'app-logstablefilter',
  templateUrl: './logstablefilter.component.html',
  styleUrls: [
    './logstablefilter.component.css',
  ],
  providers: [FilterService]
})


export class LogsTableFilterComponent implements OnInit {
