...
@Component({
  selector: 'app-productcustomdonutchart',
  templateUrl: './productcustomdonutchart.component.html',
  styleUrls: [
    './productcustomdonutchart.component.css'
  ]
})

export class ProductCustomDonutChartComponent implements OnInit {
