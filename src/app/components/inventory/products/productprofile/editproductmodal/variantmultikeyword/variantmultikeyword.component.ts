...
@Component({
  selector: 'app-variantmultikeyword',
  templateUrl: './variantmultikeyword.component.html',
  styleUrls: [
    './variantmultikeyword.component.css'
  ]
})

export class VariantMultiKeywordComponent implements AfterViewInit, OnInit {
  @Input() keywords;
