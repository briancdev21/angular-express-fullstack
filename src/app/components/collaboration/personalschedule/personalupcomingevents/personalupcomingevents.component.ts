...
@Component({
  selector: 'app-personalupcomingevents',
  templateUrl: './personalupcomingevents.component.html',
  styleUrls: [
    './personalupcomingevents.component.css'
  ]
})

export class PersonalUpcomingEventsComponent implements OnInit {
